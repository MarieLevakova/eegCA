...
// penPiCpp
arma::mat penPiCpp(arma::mat X, int n_lambda, double lambda_min, int r, int maxiter, int crit, double dt, bool w_auto, int n_cv, double q);
RcppExport SEXP _eegCA_penPiCpp(SEXP XSEXP, SEXP n_lambdaSEXP, SEXP lambda_minSEXP, SEXP rSEXP, SEXP maxiterSEXP, SEXP critSEXP, SEXP dtSEXP, SEXP w_autoSEXP, SEXP n_cvSEXP, SEXP qSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(penPiCpp(X, n_lambda, lambda_min, r, maxiter, crit, dt, w_auto, n_cv, q));
    return rcpp_result_gen;
END_RCPP
}
// surr_fit_Rcpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_eegCA_penPiCpp", (DL_FUNC) &_eegCA_penPiCpp, 10},
